...
// G B A . H
//
// Include header file for GCC-GBA programming (for chapter-4)
//
...
/*
typedef struct {
  hword data[ 32 ];			// Sprite graphic data
 } character __attribute__((packed));
...
#define OBJ_SWITCH_MASK	0x0300		// OBJ display switch bit mask
#define OBJ_SWT_TURNOFF	0x0200		// Turn off OBJ
